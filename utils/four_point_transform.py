...
def directionOfPoint(top_left, bottom_right, point):
...
def order_points(pts):
    ...
    one_result = directionOfPoint(rect[0], rect[2], pts[0])

    if one_result == "top_right":
        rect[1] = pts[0]
        rect[3] = pts[1]
    else:
        rect[1] = pts[1]
...
def four_point_transform(image, pts, order_points = False):
