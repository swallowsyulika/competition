...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.t_conv_1 = nn.ConvTranspose2d(64, 32, 4, 2, 1)

        self.t_conv_2 = nn.ConvTranspose2d(32, 16, 4, 2, 1)

        self.t_conv_3 = nn.ConvTranspose2d(16, 1, 4, 2, 1)

    def forward(self, x):

        x = F.relu(self.t_conv_1(x))
        x = F.relu(self.t_conv_2(x))
        x = F.sigmoid(self.t_conv_3(x))
