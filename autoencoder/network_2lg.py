...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv_1 = nn.Conv2d(1, 16, 4, 2, 1)

        self.conv_2 = nn.Conv2d(16, 32, 4, 2, 1)
        self.conv_2_bn = nn.BatchNorm2d(32)

        self.conv_3 = nn.Conv2d(32, 64, 4, 2, 1)
        self.conv_3_bn = nn.BatchNorm2d(64)

        self.conv_4 = nn.Conv2d(64, 128, 4, 2, 1)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.conv_4_bn(self.conv_4(x)))
